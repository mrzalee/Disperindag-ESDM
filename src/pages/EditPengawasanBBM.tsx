...
const EditPengawasanBBM: React.FC = () => {
  const { id } = useParams();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Data pengawasan BBM berhasil diperbarui!");
      ...
      <div className="w-full px-6 md:px-10 lg:px-20 py-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-3xl font-bold inline">Edit Cerapan Pengawasan Pompa Ukur BBM</h1>
            <p className="text-gray-600 mt-2">
              Edit formulir pengawasan pompa ukur BBM di SPBU
            </p>
          </div>
        </div>
...
export default EditPengawasanBBM;